...
OpenAI 发布的 Codex 能力覆盖计算机操作、浏览器、SSH 远程开发、PR 审阅、多终端、Automation 与 Memory。Codex CLI `0.145.0` 又把实验性分页 Thread History、持久名称、搜索、Sub-agent 会话与 Memories 纳入同一存储，编辑早期 Prompt 或重试受安全缓冲的 Turn 会创建保留原对话、附件与 Mention 绑定的上下文分支；`/import` 可迁移 Cursor 与 Claude Code 的 Settings、MCP Servers、Plugins、Sessions、Commands 和项目级 Memories，Multi-agent V2 也在同版稳定化。
...
- 分页历史仍为实验性，其长期增长、分支治理、跨版本恢复与导入资产权限尚未公开验证。

### 支持来源

- P1 · [Codex for almost everything](https://openai.com/index/codex-for-almost-everything/) · OpenAI · 官方产品发布 · `2026-04-16`
- P1 · [Release 0.145.0 · openai/codex](https://github.com/openai/codex/releases/tag/rust-v0.145.0) · OpenAI · GitHub Release · `2026-07-21`

### 更新历史

- `2026-07-13`：基线首次记录。
- `2026-07-22`：追加分页 Thread History、上下文分支、跨工具 Import 与 Multi-agent V2 稳定化；能力可由稳定 Release 确认，分页历史的长期可靠性仍待验证。
